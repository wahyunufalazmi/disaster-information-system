...
<h1 align="center">Data Seluruh Bencana Tanggal <?= $tanggal." ".$bulan." ".$tahun  ?></h1>
<table border="1">
        <thead>
          <tr bgcolor="silver">
             <th scope="col">No</th>
         ...
         <?php
          $data = mysqli_query($koneksi, "SELECT * FROM korban WHERE  tanggal = '$tanggal' AND bulan = '$bulan' AND tahun = '$tahun'");
          $no = 1;
        ...
        ?>
         ...
         <tr>
           ...
           <td bgcolor="silver">
             ...
             $query = "SELECT SUM(lukaringan) FROM korban WHERE  tanggal = '$tanggal' AND bulan = '$bulan' AND tahun = '$tahun'";    
        ...
        // Print out result
         ...
         ?>
           ...
           <td bgcolor="silver">
            ...
            $query = "SELECT SUM(lukaberat) FROM korban WHERE  tanggal = '$tanggal' AND bulan = '$bulan' AND tahun = '$tahun'";    
            $result = mysqli_query($koneksi,$query) or die(mysql_error());
        ...
        ?>
           ...
           <td bgcolor="silver">
            ...
            $query = "SELECT SUM(meninggal) FROM korban WHERE  tanggal = '$tanggal' AND bulan = '$bulan' AND tahun = '$tahun'";    
            $result = mysqli_query($koneksi,$query) or die(mysql_error());
        ...
        ?>
           ...
           <td bgcolor="silver">
                  ...
                  $query = "SELECT SUM(kerugian) FROM korban WHERE  tanggal = '$tanggal' AND bulan = '$bulan' AND tahun = '$tahun' ";    
                  $result = mysqli_query($koneksi,$query) or die(mysql_error());
