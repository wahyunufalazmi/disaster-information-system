...
<h1 align='center'>Laporan Kejadian Bencana Tahun <?php echo $tahun ?> Kabupaten Boyolali</h1>
<table border="1">
        <thead>
          <tr bgcolor="silver">
            <th>No</th>
         ...
         <?php
          $data = mysqli_query($koneksi, "SELECT * FROM bencana WHERE tahun = '$tahun'");
          $no = 1;
      ...
      <center><h1>Intensitas Terjadinya Bencana Alam Tahun <?php echo $tahun; ?></h1></center>
         ...
         <tr>
            ...
            <td>
              <?php
                $tipe = "Gempa Bumi";
                $kec = "Selo";
                $query = "SELECT COUNT(*) FROM bencana WHERE tipe = '$tipe' AND tahun = '$tahun' AND kecamatan = '$kec'";
...
<td>
         ...
         <td>
            ...
            <td>Total</td>
              <td>
                ...
                $query = "SELECT COUNT(tipe) FROM bencana WHERE tahun = '$tahun' AND tipe = '$tipe'";
                $result = mysqli_query($koneksi,$query) or die(mysql_error());
      ...
      <center><h1>Total Korban Akibat Bencana Tahun <?php echo $tahun; ?></h1></center>
      <table border="1" align="center">
        <thead>
          <tr bgcolor="silver">
              ...
              $query = "SELECT SUM(korbanhilang) FROM bencana WHERE tahun = '$tahun'";    
              $result = mysqli_query($koneksi,$query) or die(mysql_error());
          ...
          // Print out result
            ...
            <th>
              <?php
               ...
               $query = "SELECT SUM(korbanluka) FROM bencana WHERE tahun = '$tahun'";    
              $result = mysqli_query($koneksi,$query) or die(mysql_error());
            ...
            <th>
              ...
              $query = "SELECT SUM(korbanmengungsi) FROM bencana WHERE tahun = '$tahun'";    
              $result = mysqli_query($koneksi,$query) or die(mysql_error());
          ...
          <tr>
             <td>
              ...
              // Make a MySQL Connection
                  $query = "SELECT tipe, kecamatan, SUM(korbanhilang) FROM bencana WHERE tahun = '$tahun' GROUP BY tipe";    
                  $result = mysqli_query($koneksi,$query) or die(mysql_error());
            ...
            <td>
              ...
              // Make a MySQL Connection
                  $query = "SELECT tipe, kecamatan, SUM(korbanluka) FROM bencana WHERE tahun = '$tahun' GROUP BY tipe";    
                  $result = mysqli_query($koneksi,$query) or die(mysql_error());
            ...
            <td>
              ...
              // Make a MySQL Connection
                  $query = "SELECT tipe, kecamatan, SUM(korbanmengungsi) FROM bencana WHERE tahun = '$tahun' GROUP BY tipe";    
                  $result = mysqli_query($koneksi,$query) or die(mysql_error());
      ...
      <center><h1>Total Rumah Rusak Akibat Bencana Tahun <?php echo $tahun; ?></h1></center>
      <table border="1" align="center">
        <thead>
          <tr bgcolor="silver">
              ...
              $query = "SELECT SUM(rusakringan) FROM bencana WHERE tahun = '$tahun'";    
              $result = mysqli_query($koneksi,$query) or die(mysql_error());
          ...
          // Print out result
            ...
            <th>
              <?php
               ...
               $query = "SELECT SUM(rusaksedang) FROM bencana WHERE tahun = '$tahun'";    
              $result = mysqli_query($koneksi,$query) or die(mysql_error());
            ...
            <th>
              ...
              $query = "SELECT SUM(rusakberat) FROM bencana WHERE tahun = '$tahun'";    
              $result = mysqli_query($koneksi,$query) or die(mysql_error());
             ...
             <th>
              ...
              $query = "SELECT SUM(kerugian) FROM bencana WHERE tahun = '$tahun'";    
              $result = mysqli_query($koneksi,$query) or die(mysql_error());
        ...
        <tbody>
          <tr>
             <td>
              ...
              // Make a MySQL Connection
                  $query = "SELECT tipe, kecamatan, SUM(rusakringan) FROM bencana WHERE tahun = '$tahun' GROUP BY tipe";    
                  $result = mysqli_query($koneksi,$query) or die(mysql_error());
            ...
            <td>
              ...
              // Make a MySQL Connection
                  $query = "SELECT tipe, kecamatan, SUM(rusaksedang) FROM bencana WHERE tahun = '$tahun' GROUP BY tipe";    
                  $result = mysqli_query($koneksi,$query) or die(mysql_error());
            ...
            <td>
              ...
              // Make a MySQL Connection
                  $query = "SELECT tipe, kecamatan, SUM(rusakberat) FROM bencana WHERE tahun = '$tahun' GROUP BY tipe";    
                  $result = mysqli_query($koneksi,$query) or die(mysql_error());
            ...
            <td>
              ...
              // Make a MySQL Connection
                  $query = "SELECT tipe, kecamatan, SUM(kerugian) FROM bencana WHERE tahun = '$tahun' GROUP BY tipe";    
                  $result = mysqli_query($koneksi,$query) or die(mysql_error());
