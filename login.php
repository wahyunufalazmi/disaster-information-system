...
<html>
  <head>
    <title>Login as Administator</title>
...
<div class="container"><b>
      <h1><center>FORM LOGIN ADMIN</center></h1><br>
        <div class="col-md-6 offset-md-3">
        <form action="cek_login.php" method="post">
          <div class="form-group">
            <label>USERNAME</label>
            <input type="text" class="form-control" name="nip"  placeholder="inputkan username dengan benar. . . . . . ." required>
          </div>
          <div class="form-group">
