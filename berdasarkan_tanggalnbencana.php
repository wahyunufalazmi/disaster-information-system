...
<h1 align="center">Bencana <?=  $tipe." Tanggal ".$tanggal." ".$bulan." ".$tahun ?></h1>
...
<table border="1">
        <thead>
         ...
         <?php
          $data = mysqli_query($koneksi, "SELECT * FROM korban WHERE tipe = '$tipe' AND tanggal = '$tanggal' AND bulan = '$bulan' AND tahun = '$tahun'");
          $no = 1;
        ...
        ?>
         ...
         <tr>
           ...
           <td bgcolor="silver">
             ...
             $query = "SELECT SUM(lukaringan) FROM korban WHERE tipe = '$tipe' AND tanggal = '$tanggal' AND bulan = '$bulan' AND tahun = '$tahun'";    
        ...
        // Print out result
         ...
         ?>
           ...
           <td bgcolor="silver">
            ...
            $query = "SELECT SUM(lukaberat) FROM korban WHERE tipe = '$tipe' AND tanggal = '$tanggal' AND bulan = '$bulan' AND tahun = '$tahun'";    
            $result = mysqli_query($koneksi,$query) or die(mysql_error());
        ...
        ?>
           ...
           <td bgcolor="silver">
            ...
            $query = "SELECT SUM(meninggal) FROM korban WHERE tipe = '$tipe' AND tanggal = '$tanggal' AND bulan = '$bulan' AND tahun = '$tahun'";    
            $result = mysqli_query($koneksi,$query) or die(mysql_error());
        ...
        ?>
           ...
           <td bgcolor="silver">
                  ...
                  $query = "SELECT SUM(kerugian) FROM korban WHERE tipe = '$tipe' AND tanggal = '$tanggal' AND bulan = '$bulan' AND tahun = '$tahun' ";    
                  $result = mysqli_query($koneksi,$query) or die(mysql_error());
