...
<h1 align="center">Bencana <?= $tipe." Tahun ".$tahun; ?></h1>
<table border="1">
        <thead>
          <tr bgcolor="silver">
             <th scope="col">No</th>
         ...
         <?php
          $data = mysqli_query($koneksi, "SELECT * FROM korban WHERE tipe = '$tipe' AND tahun = '$tahun'");
          $no = 1;
         ...
         <tbody>
          ...
          <td><?php echo $no; ?></td>
           ...
           <td bgcolor="silver">
             ...
             $query = "SELECT SUM(lukaringan) FROM korban WHERE tipe = '$tipe' AND  tahun = '$tahun'";    
        ...
        // Print out result
         ...
         ?>
           ...
           <td bgcolor="silver">
            ...
            $query = "SELECT SUM(lukaberat) FROM korban WHERE tipe = '$tipe' AND  tahun = '$tahun'";    
            $result = mysqli_query($koneksi,$query) or die(mysql_error());
        ...
        ?>
           ...
           <td bgcolor="silver">
            ...
            $query = "SELECT SUM(meninggal) FROM korban WHERE tipe = '$tipe' AND  tahun = '$tahun'";    
            $result = mysqli_query($koneksi,$query) or die(mysql_error());
        ...
        ?>
           ...
           <td bgcolor="silver">
                  ...
                  $query = "SELECT SUM(kerugian) FROM korban WHERE tipe = '$tipe' AND  tahun = '$tahun' ";    
                  $result = mysqli_query($koneksi,$query) or die(mysql_error());
