...
<h1 align="center">Bencana <?php echo $tipe." Bulan ".$bulan." "; echo $tahun; ?></h1>
<table border="1">
        <thead>
          <tr bgcolor="silver">
             <th scope="col">No</th>
         ...
         <?php
          $data = mysqli_query($koneksi, "SELECT * FROM korban WHERE tipe = '$tipe' AND bulan = '$bulan' AND tahun = '$tahun'");
          $no = 1;
  ...
  <td>
          ...
          <tr>
           ...
           <td bgcolor="silver">
             ...
             $query = "SELECT SUM(lukaringan) FROM korban WHERE tipe = '$tipe' AND bulan = '$bulan' AND tahun = '$tahun'";    
        ...
        // Print out result
         ...
         ?>
           ...
           <td bgcolor="silver">
            ...
            $query = "SELECT SUM(lukaberat) FROM korban WHERE tipe = '$tipe' AND bulan = '$bulan' AND tahun = '$tahun'";    
            $result = mysqli_query($koneksi,$query) or die(mysql_error());
        ...
        ?>
           ...
           <td bgcolor="silver">
            ...
            $query = "SELECT SUM(meninggal) FROM korban WHERE tipe = '$tipe' AND bulan = '$bulan' AND tahun = '$tahun'";    
            $result = mysqli_query($koneksi,$query) or die(mysql_error());
        ...
        ?>
           ...
           <td bgcolor="silver">
                  ...
                  $query = "SELECT SUM(kerugian) FROM korban WHERE tipe = '$tipe' AND bulan = '$bulan' AND tahun = '$tahun' ";    
                  $result = mysqli_query($koneksi,$query) or die(mysql_error());
