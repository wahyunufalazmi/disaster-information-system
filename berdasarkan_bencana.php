...
<h1 align="center"> Data Seluruh Bencana <?php echo $tipe ?></h1>
<table border="1">
        <thead>
          <tr bgcolor="silver">
             <th scope="col">No</th>
         ...
         <?php
          $data = mysqli_query($koneksi, "SELECT * FROM korban WHERE tipe = '$tipe' ");
          $no = 1;
         ...
         <tbody>
          ...
          <td><?php echo $no; ?></td>
           ...
           <td>
            ...
            <td>
              <?php echo $array['tingkatkerugian'];
              ?>
            </td>
           <?php $no++; endwhile; ?>
          </tr>
           ...
           <td bgcolor="silver">
             ...
             $query = "SELECT SUM(lukaringan) FROM korban WHERE tipe = '$tipe'";    
        ...
        // Print out result
         ...
         ?>
           ...
           <td bgcolor="silver">
            ...
            $query = "SELECT SUM(lukaberat) FROM korban WHERE tipe = '$tipe'";    
            $result = mysqli_query($koneksi,$query) or die(mysql_error());
        ...
        ?>
           ...
           <td bgcolor="silver">
            ...
            $query = "SELECT SUM(meninggal) FROM korban WHERE tipe = '$tipe'";    
            $result = mysqli_query($koneksi,$query) or die(mysql_error());
        ...
        ?>
           ...
           <td bgcolor="silver">
                  ...
                  $query = "SELECT SUM(kerugian) FROM korban WHERE tipe = '$tipe' ";    
                  $result = mysqli_query($koneksi,$query) or die(mysql_error());
